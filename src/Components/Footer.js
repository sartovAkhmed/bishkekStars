    ...
    <div className="footer-section">
      <Container>
          ...
          <div className="ft-info">
            <div className="ft-info-p1">
              ...
              <p className="ft-description">
                ...
                площадками, освещением, удобными лавочками и велодорожками
                создадут уютные места для отдыха и встреч жителей.
              </p>
            </div>
        ...
        <div className="ft-copyright">
          <p>
            © 2013-2023 BishkekStars+. Согласовано с именем команды ПОАС 2-24
          </p>
